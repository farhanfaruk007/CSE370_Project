...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	...
	if(isset($_POST["addToCart"])){
		...
		if($count > 0){
			...
			$sql = "SELECT user_id,p_id FROM cart WHERE ip_add = '$ip_add' AND p_id = '$p_id' AND user_id = -1";
...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_image,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($con,$sql);
		...
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					//checkout form payment gatway
					echo '
						 </form>
						 <form action="payment.php" method="post">
						 	<input type="submit" style="float:right;" name="business" class="btn btn-info btn-lg" value="Proceed To Payment">';
